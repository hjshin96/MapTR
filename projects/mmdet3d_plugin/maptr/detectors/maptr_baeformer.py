...
class MapTRBAEFormer(MVXTwoStageDetector):
    """MapTR.
    Args:
    ...
    def forward_pts_train(self,
        ...
        outs = self.pts_bbox_head(img_inputs, lidar_feat, img_metas, prev_bev)
    ...
    def forward_train(self,
        ...
        img_feats = None
        losses = dict()
        img_inputs['img_feats'] = img_feats
        img_inputs['img'] = img
        img_inputs['img_backbone'] = self.img_backbone
        losses_pts = self.forward_pts_train(img_inputs, lidar_feat, gt_bboxes_3d, gt_labels_3d, img_metas, gt_bboxes_ignore, prev_bev)
...
@DETECTORS.register_module()
class MapTRBAEFormer_fp16(MapTRBAEFormer):
    """
