...
class MapTRHeadBAEFormer(DETRHead):
    """Head of Detr3D.
    Args:
    ...
    def __init__(self,
        ...
        super(MapTRHeadBAEFormer, self).__init__(
    ...
    def forward(self, img_inputs, lidar_feat, img_metas, prev_bev=None,  only_bev=False):
        """Forward function.
        Args:
        ...
        bs, num_cam, _, _, _ = img_inputs['img'][0].shape
        if img_inputs['img_feats'] is not None:
            dtype = img_inputs['img_feats'][0].dtype
        else:
            dtype = torch.float32
